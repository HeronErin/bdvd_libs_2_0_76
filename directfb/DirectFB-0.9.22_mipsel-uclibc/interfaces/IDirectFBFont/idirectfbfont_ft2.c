           ...
           DFBFontDescription *desc )
{
     ...
     font->line_height= face->height;
     font->layout     = layout;

     D_DEBUG( "DirectFB/FontFT2: [xm] font->height is %d\n", font->height );
     D_DEBUG( "DirectFB/FontFT2: [xm] font->y_ppem is %d\n", face->size->metrics.y_ppem );

     D_DEBUG( "DirectFB/FontFT2: font->height = %d\n", font->height );
     D_DEBUG( "DirectFB/FontFT2: font->ascender = %d\n", font->ascender );
     D_DEBUG( "DirectFB/FontFT2: font->descender = %d\n",font->descender );
	 ...
	 /*PR10573*/
	  impl_data->stroking_enabled = (desc->attributes & DFFA_STROKING);
//	 impl_data->stroking_enabled = 0;
     ...
     if (desc->flags & DFDESC_FIXEDADVANCE) {
          impl_data->fixed_advance = desc->fixed_advance;
