...
PLATFORMS=7440b0 7601 7635 7405a0
...
# >> END {print $$x} 
#################################
TMP := $(shell perl -nae 'if (10>$$.) { $$x.=" $$F[2]" if /^(VERSION|PATCHLEVEL|SUBLEVEL|EXTRAVERSION)/; } END {print $$x}'  ../stblinux-2.6.24/Makefile) XXX YYY ZZZ
